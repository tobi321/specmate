...
public class AttributeToSQLMapper extends SQLMapper {
	...
	public void migrateNewStringAttribute(String objectName, String attributeName, String defaultValue)
		...
		// TODO Add info messages like these for all migrations, as soon as we
		// know how to handle errors in migration steps
		// and do a roll back
		// logService.log(LogService.LOG_INFO, "Migration: Added new string
		// attribute " + attributeName + " to object " + objectName);
	}
	...
	public void migrateNewReference(String objectName, String attributeName) throws SpecmateException {
		...
		queries.add("CREATE UNIQUE INDEX " + SQLUtil.createRandomIdentifier("PRIMARY_KEY_" + attributeName) + " ON "
				+ tableNameList + " (CDO_SOURCE ASC, CDO_VERSION ASC, CDO_IDX ASC)");

		queries.add("ALTER TABLE " + tableNameList + " ADD CONSTRAINT "
				+ SQLUtil.createRandomIdentifier("CONSTRAINT_" + attributeName)
	...
	public void migrateRenameAttribute(String objectName, String oldAttributeName, String newAttributeName)
		...
		List<String> queries = new ArrayList<>();
		// queries.add("ALTER TABLE " + objectName + " ALTER " +
		// oldAttributeName + " RENAME TO " + newAttributeName); --> H2
