...
public abstract class MigrationTestBase {
	...
	public void doMigration() throws Exception {
		...
		// Resetting the model to the base model such that all tests start
		// with the same model
	...
	protected Dictionary<String, Object> getPersistencyProperties() {
		Dictionary<String, Object> properties = new Hashtable<>();
		// properties.put(CDOPersistenceConfig.KEY_JDBC_CONNECTION,
		...
		// "specmateResource");
		// properties.put(CDOPersistenceConfig.KEY_USER_RESOURCE_NAME,
		// "userResource");

		properties.put(CDOPersistenceConfig.KEY_JDBC_CONNECTION, "jdbc:oracle:thin:@sla13791.srv.allianz:1521:AZPV01T");
		properties.put(CDOPersistenceConfig.KEY_REPOSITORY_NAME, "specmatedev");
		...
		properties.put(CDOPersistenceConfig.KEY_ORACLE_USERNAME, "SPECMATEDEV");
		properties.put(CDOPersistenceConfig.KEY_ORACLE_PASSWORD, "Aut0_T3$T");
		properties.put(CDOPersistenceConfig.KEY_DB_TYPE, CDOPersistenceConfig.DB_ORACLE);
	...
	private void loadBaselineTestdata(com.specmate.migration.test.baseline.testmodel.base.Folder root) {
		...
		Sketch f0 = ArtefactFactory.eINSTANCE.createSketch();
		f0.setId("f0");
		f0.setTested(false);
